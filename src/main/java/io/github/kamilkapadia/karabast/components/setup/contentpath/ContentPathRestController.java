...
public class ContentPathRestController {
	...
	public ResponseEntity<RestResponse> find(@PathVariable String id) {
		...
		try {
			...
			if (contentPath != null) {
				ContentPathModel data = new ContentPathModel(contentPath, baseUrlString);
	...
	public ResponseEntity<RestResponse> findAll() {
		...
		try {
			...
			List<ContentPathModel> data = new ArrayList<>();

			for (ContentPath contentPath : contentPaths) {
				data.add(new ContentPathModel(contentPath, baseUrlString));
			}
