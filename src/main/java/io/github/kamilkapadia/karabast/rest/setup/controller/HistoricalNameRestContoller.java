...
import io.github.kamilkapadia.karabast.rest.setup.response.HistoricalNameResponse;
...
public class HistoricalNameRestContoller {
	...
	public ResponseEntity<RestResponse> find(@PathVariable String id) {
		...
		try {
			...
			if (historicalName != null) {
				HistoricalNameResponse data = new HistoricalNameResponse(historicalName, baseUrlString);
	...
	public ResponseEntity<RestResponse> findAll() {
		...
		try {
			...
			List<HistoricalNameResponse> data = new ArrayList<>();

			for (HistoricalName historicalName : historicalNames) {
				data.add(new HistoricalNameResponse(historicalName, baseUrlString));
			}
