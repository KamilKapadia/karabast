...
import io.github.kamilkapadia.karabast.rest.lookup.response.RuleCodeResponse;
...
public class RuleCodeRestController {
	...
	public ResponseEntity<RestResponse> find(@PathVariable String id) {
		...
		try {
			...
			if (ruleCode != null) {
				RuleCodeResponse data = new RuleCodeResponse(ruleCode);
	...
	public ResponseEntity<RestResponse> findAll() {
		...
		try {
			...
			List<RuleCodeResponse> data = new ArrayList<>();
			
			for (RuleCode ruleCode : ruleCodes) {
				data.add(new RuleCodeResponse(ruleCode));
			}
